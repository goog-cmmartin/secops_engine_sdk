...
class SecopsDispatcherAgent(BaseSecOpsAdkAgent):
    ...
    CAPABILITIES = ['rule.audit_health', 'parser.audit_health', 'feed.audit_health', 'parser.diagnose_unparsed', 'gcp_logging.search', 'dashboard.execute_query', 'mitre.analyze_coverage']
